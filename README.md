...
Crear un nuevo archivo llamado `index.html` donde deberás realizar lo siguiente:
...
I. Cree una página HTML básica
  ...
  C. En el cuerpo, crea tres divs.
    1. En el primer div crea:
      ...
      * un elemento p que contiene "desafío de html_introduccion".
...
II. Cree una página HTML básica
  ...
  A. Cree el diseño básico para la página principal usando html, head y body.
    1. En la primera página crea:
      * un elemento h1 que contiene [El nombre de la empresa].
      * un elemento h4 que contiene "las promociones del día" y cada h4 contiene:
    ...
    2. En la segunda, tercera y cuarta página crea:
      ...
      * un elemento h4 que contiene una descripción de la promoción.
